...
import { _ICollection, _IDocumentSnapshot } from "./types/collection.types";
...
export default class _DocumentSnapshot<T extends Entity> // eslint-disable-next-line @typescript-eslint/indent
  implements _IDocumentSnapshot<T>
{
  /**
   * @hidden
   */
